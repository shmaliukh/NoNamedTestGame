...
import com.nonamed.hackathon2022testgame.game_objects.micro.AbstractPerson;
import com.nonamed.hackathon2022testgame.game_objects.micro.DarkPerson;
...
public final class GameWorldHandler implements Serializable {
    ...
    public GameWorldHandler() {
        ...
        gameWorld.registerObject(idToSet, HERO.getGroup());
